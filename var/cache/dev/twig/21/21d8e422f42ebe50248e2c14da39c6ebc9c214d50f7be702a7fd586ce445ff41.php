...
/* home/add.html.twig */
class __TwigTemplate_38d1c3170e570202834df802ff71a3340c5ec98612d04314d99c75d1a709a2bf extends Template
{
    private $source;
    private $macros = [];
...
<div style=\"text-align:center\">
    <h1 style=\"text-align:center\">Ajouter un nouveau job </h1>
    <a href=\"";
        // line 13
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("home_show");
        echo "\" class=\"btn btn-outline-primary\">Liste des offres</a>
    <br>
</div>
    ";
        // line 16
        $this->loadTemplate("home/job_form.html.twig", "home/add.html.twig", 16)->display($context);
        // line 17
        echo "    ";
...
";
    ...
    {
        return array (  129 => 22,  119 => 21,  109 => 17,  107 => 16,  101 => 13,  93 => 8,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
...
{% block title %}Ajout de Job{% endblock %}
...
<div style=\"text-align:center\">
    <h1 style=\"text-align:center\">Ajouter un nouveau job </h1>
    <a href=\"{{ path('home_show') }}\" class=\"btn btn-outline-primary\">Liste des offres</a>
    <br>
</div>
    {% include \"home/job_form.html.twig\" %}
    {# {{form(form)}} #}
{% endblock %}
...
\t\t\$('select').formSelect();
\t</script>
{% endblock %}", "home/add.html.twig", "/var/www/html/Symfo5_Pole_Emploi/templates/home/add.html.twig");
    }
}
